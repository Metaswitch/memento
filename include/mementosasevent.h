...
namespace SASEvent
{
  ...
  const int CALL_LIST_DB_RETRIEVAL_START = MEMENTO_BASE + 0x000032;
  const int CALL_LIST_DB_RETRIEVAL_SUCCESS = MEMENTO_BASE + 0x000033;
  const int CALL_LIST_DB_RETRIEVAL_FAILED = MEMENTO_BASE + 0x000034;
  const int CALL_LIST_DB_INVALID_RECORD_1 = MEMENTO_BASE + 0x000035;
  const int CALL_LIST_DB_INVALID_RECORD_2 = MEMENTO_BASE + 0x000036;
  const int CALL_LIST_DB_INVALID_RECORD = MEMENTO_BASE + 0x000037;
  const int CALL_LIST_DB_BAD_XML = MEMENTO_BASE + 0x000038;
