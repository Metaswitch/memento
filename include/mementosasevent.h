...
namespace SASEvent
{
  ...
  const int CALL_LIST_BEGIN_FRAGMENT = MEMENTO_BASE + 0x000030;
  const int CALL_LIST_REJECTED_FRAGMENT = MEMENTO_BASE + 0x000031;
  const int CALL_LIST_END_FRAGMENT = MEMENTO_BASE + 0x000032;
  const int CALL_LIST_TRIM_NEEDED = MEMENTO_BASE + 0x000033;
  const int CALL_LIST_OVERLOAD = MEMENTO_BASE + 0x000034;
} //namespace SASEvent
